<template>
  <div>
    <div class="profile">
      ...
      <figure class="followinglabel">Following</figure>
      <div class="following">
...
.profile {
  ...
  grid-template-rows: 31% 5% 9% 6% 9% 5% 18% 5% 15% 7%;
  gap: 1px 1px;
  grid-template-areas: "profileavatar profileavatar" "profilename profilename" "userlogin userlogin" "localitylabel birthdaylabel" "locality birthday" "biographylabel biographylabel" "biography biography" "followerslabel followinglabel" "followers following" "ratinglabel ratinglabel" "rating rating";
}
.icon {
  font-size: 26px;
}
